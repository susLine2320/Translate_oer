//
// Generated on 2023/02/08 by inimoni 
//
...
#ifndef TRANSLATE_OERINI_H
#define TRANSLATE_OERINI_H
...
/**
    translate_oer.ini input output class.
*/
class Translate_oerIni
{
public:

    Translate_oerIni(string_t fname = _T(""))
    {
        initFileName = _T("./translate_oer.ini"); //Default file.    
        init();
        load(fname);
    }
...
protected:
    ...
    bool iniRW(string_t f, int r)
    {
        ...
        s = _T("Values");
        inimoni::inirw(r, f, s, _T("UsebrakeOpen     "), Values.UsebrakeOpen);
        return true;
    }

    void init()
    {
        Values.UsebrakeOpen = 1;
    }
};
typedef Translate_oerIni Translate_oerFile; //êVãåå›ä∑
